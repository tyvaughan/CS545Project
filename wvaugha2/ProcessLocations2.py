...
# This file reads users in and obtains their locations from the file created by ReadUsers.py.
...
def getLocation(location):
    ...
    if(not countryFound and cityFound):
        try:
            ...
            # Get the coordinates.
            coords = GPS[index]
            return True, "{};{};{};;{};{}".format(loc, code, location[index2], coords[0], coords[1])
        except:
            return False, ''
